...
userRouter.post('/send-rejected-email', async (req, res) => {
  ...
  const data = JSON.stringify({
    ...
    subject: "KIBO - Account Approved Rejected",
    htmlContent: `
      <html>
      <style>
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p> Hey ${fullName}</p>
                        <p> Unfortunately, Your request to access Zoho Ticket Portal is Rejected. </p>
                        <p> Please contact the Admin for any further information. </p>
                      </td>
                    </tr>
                  </table>
                </td>
